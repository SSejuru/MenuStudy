 ...
 */
UCLASS()
class MENUSTUDY_API UDataAsset_DataListEntryMapping : public UDataAsset
{
	GENERATED_BODY()
	
public:
	
	TSubclassOf<UWidget_ListEntry_Base> GetEntryWidgetClassByDataObject(UListDataObject_Base* InDataObject) const;
